package ecomhub.cartservice.cartservice.event.listener;

import com.fasterxml.jackson.databind.ObjectMapper;
import ecomhub.cartservice.cartservice.config.KafkaConfig;
import ecomhub.cartservice.cartservice.event.model.ResourceEvent;
