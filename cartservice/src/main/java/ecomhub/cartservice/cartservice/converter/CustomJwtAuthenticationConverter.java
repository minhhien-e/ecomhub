package ecomhub.cartservice.cartservice.converter;
...
public class CustomJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        CustomUser user = new CustomUser(userId, null, authorities);
        log.info("Authenticated user: {} with id: {}", null, userId);
